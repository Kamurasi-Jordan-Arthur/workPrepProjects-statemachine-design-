//$file${./qk::bsp.c} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
...
#include "AudioPlayer.h"                 // DPP Application interface
...
// To be used as our volume up button
#define VOL_UP   13U

//pin to be used for volume down functions (i.e PB10)
#define VOL_DOWN 6U

//pin to be used for mode transition
#define MODE_PIN 7U

#define PLAYPAUSE_PIN 14U
...
//    QACTIVE_POST(AO_AudioPlayer, &testEvt, &l_EXTI0_1_IRQHandler);
//
//    QK_ISR_EXIT();    // inform QK about exiting an ISR
//}
