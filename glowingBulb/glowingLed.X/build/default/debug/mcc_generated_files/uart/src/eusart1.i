...
# 49 "mcc_generated_files/uart/src/../../system/../system/clock.h"
...
# 1 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h" 1
# 48 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h"
# 1 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_interface.h" 1
# 56 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_interface.h"
typedef struct{
    void (*Initialize)(void);
    void (*Process)(void);
}DVRT_interface_t;
# 49 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h" 2
# 1 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_types.h" 1
# 42 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_types.h"
# 1 "mcc_generated_files/uart/src/../eusart1.h" 1
# 43 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_types.h" 2
# 1 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_config.h" 1
# 44 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_types.h" 2
# 56 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_types.h"
...
# 73 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime_types.h"
...
# 50 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h" 2
# 68 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h"
extern const DVRT_interface_t DVRT;
# 78 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h"
void DVRT_Initialize(void);
# 88 "mcc_generated_files/uart/src/../../system/../DVRT/DVRunTime.h"
...
# 346 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
void TMR2_Start(void);
# 355 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
void TMR2_Stop(void);
# 364 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
uint8_t TMR2_CounterGet(void);
# 373 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
void TMR2_CounterSet(uint8_t count);
# 382 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
void TMR2_PeriodSet(uint8_t periodVal);
# 391 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
...
# 408 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
void TMR2_ModeSet(TMR2_HLT_MODE mode);
# 417 "mcc_generated_files/uart/src/../../system/../timer/tmr2.h"
...
# 90 "mcc_generated_files/uart/src/../eusart1.h"
typedef union {
    struct {
        uint8_t perr : 1;
        uint8_t ferr : 1;
...
# 108 "mcc_generated_files/uart/src/../eusart1.h"
extern const uart_drv_interface_t UART1;
# 117 "mcc_generated_files/uart/src/../eusart1.h"
...
# 150 "mcc_generated_files/uart/src/../eusart1.h"
...
# 167 "mcc_generated_files/uart/src/../eusart1.h"
...
# 264 "mcc_generated_files/uart/src/../eusart1.h"
_Bool EUSART1_IsRxReady(void);
# 273 "mcc_generated_files/uart/src/../eusart1.h"
_Bool EUSART1_IsTxReady(void);
# 282 "mcc_generated_files/uart/src/../eusart1.h"
...
# 300 "mcc_generated_files/uart/src/../eusart1.h"
uint8_t EUSART1_Read(void);
# 310 "mcc_generated_files/uart/src/../eusart1.h"
...
# 335 "mcc_generated_files/uart/src/../eusart1.h"
...
# 360 "mcc_generated_files/uart/src/../eusart1.h"
...
static volatile uint8_t eusart1TxBuffer[(8U)];
...
static volatile uint8_t eusart1RxBuffer[(32U)];





static volatile eusart1_status_t eusart1RxStatusBuffer[(32U)];
...
static void (*EUSART1_TxCompleteInterruptHandler)(void) = ((void*)0);

void (*EUSART1_RxInterruptHandler)(void);
static void (*EUSART1_RxCompleteInterruptHandler)(void) = ((void*)0);
...
size_t EUSART1_ErrorGet(void)
{
    eusart1RxLastError.status = eusart1RxStatusBuffer[(eusart1RxTail) & ((32U) - 1U)].status;
...
uint8_t EUSART1_Read(void)
{
    ...
    tempRxTail = (eusart1RxTail + 1U) & ((32U) - 1U);
...
void EUSART1_ReceiveISR(void)
{
 ...
 uint8_t tempRxHead;
    ...
    tempRxHead = (eusart1RxHead + 1U) & ((32U) - 1U);
  ...
  eusart1RxCount++;
    ...
    if(((void*)0) != EUSART1_RxCompleteInterruptHandler)
    {
...
void EUSART1_Write(uint8_t txData)
{
    ...
    else if(0U < eusart1TxBufferRemaining)
    {
       eusart1TxBuffer[eusart1TxHead] = txData;
       tempTxHead = (eusart1TxHead + 1U) & ((8U) - 1U);
...
void EUSART1_TransmitISR(void)
{
    ...
    if(sizeof(eusart1TxBuffer) > eusart1TxBufferRemaining)
    {
       ...
       tempTxTail = (eusart1TxTail + 1U) & ((8U) - 1U);
    ...
    if(((void*)0) != EUSART1_TxCompleteInterruptHandler)
    {
